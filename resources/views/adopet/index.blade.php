...
@section('content')
        <main id = "home-main">
            ...
            <section class="collage">
                <a href ="{{ url('adopets/pets#dogsec')}}">
                    <div class="single">
                ...
                <a href ="{{ url('adopets/pets#catsec') }}">
                        <div class="single">
                ...
                <a href ="{{ url('adopets/pets#hamstersec') }}">
                    <div class="single">
            ...
            <section class="collage">
                <a href ="{{ url('adopets/pets#birdsec')}}">
                    <div class="single">
                ...
                <a href ="{{ url('adopets/pets#turtlesec') }}">
                    <div class="single">
                ...
                <a href ="{{ url('adopets/pets#fishsec') }}">
                    <div class="single">
